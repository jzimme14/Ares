...
//238882/1373120/2.50/16/2/Connector
...
(library Library_1
	...
	(patternDef "RHDR16W70P0X254_1X16_4104X250X" (originalName "RHDR16W70P0X254_1X16_4104X250X")
		(multiLayer
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.72 1.5) (pt 40.17 1.5) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 40.17 1.5) (pt 40.17 -1.5) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 40.17 -1.5) (pt -1.72 -1.5) (width 0.05))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.47 -1.25) (pt -1.47 1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.47 1.25) (pt 39.92 1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 39.92 1.25) (pt 39.92 -1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 39.92 -1.25) (pt -1.47 -1.25) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0 -1.25) (pt 39.92 -1.25) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 39.92 -1.25) (pt 39.92 1.25) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 39.92 1.25) (pt -1.47 1.25) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.47 1.25) (pt -1.47 0) (width 0.2))
		)
	)
	(symbolDef "M20-7821642" (originalName "M20-7821642")
	...
	(compDef "M20-7821642" (originalName "M20-7821642") (compHeader (numPins 16) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "M20-7821642"))
		(attachedPattern (patternNum 1) (patternName "RHDR16W70P0X254_1X16_4104X250X")
			(numPads 16)
			(padPinMap
		...
		(attr "Mouser Part Number" "855-M20-7821642")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Harwin/M20-7821642?qs=ulE8k0yEMYYHOwsI6S7TGA%3D%3D")
		(attr "Manufacturer_Name" "Harwin")
		(attr "Manufacturer_Part_Number" "M20-7821642")
		(attr "Description" "2.54mm (0.1") Pitch SIL Vertical Throughboard Socket Assembly, selective gold + tin, 16 contacts")
		(attr "<Hyperlink>" "https://cdn.harwin.com/pdfs/M20-782.pdf")
		(attr "<Component Height>" "8.65")
		(attr "<STEP Filename>" "M20-7821642.stp")
